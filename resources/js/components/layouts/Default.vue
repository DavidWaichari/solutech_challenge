    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <router-link class="collapse-item" to="/users">Users List</router-link>
                <router-link class="collapse-item" to="/users_create">Add User</router-link>
            </div>
        </div>
    </li>
    <li class="nav-item">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        ...
                        <img class="img-profile rounded-circle"
                            src="https://solutech-challenge.herokuapp.com/admin/img/undraw_profile.svg">
                    </a>
